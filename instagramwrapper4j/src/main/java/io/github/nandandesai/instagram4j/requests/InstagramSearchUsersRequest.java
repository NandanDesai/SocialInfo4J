...
import io.github.nandandesai.instagram4j.requests.payload.InstagramSearchUsersResult;
...
public class InstagramSearchUsersRequest extends InstagramGetRequest<InstagramSearchUsersResult> {
    ...
    public InstagramSearchUsersRequest(String query) {
        this.query = query;
    }
    ...
    @Override
    public InstagramSearchUsersResult parseResult(int statusCode, String content) throws IllegalAccessException, IOException, InstantiationException {
